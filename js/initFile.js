...
async function init(formularioIds, columnasFormulario, tableBD, tableBodyId, columnasTabla, nombreIndicePK,tipo){
    ...
    rowHandlers(formularioIds, columnasFormulario, tableBodyId, nombreIndicePK, tableBD,tipo);
}
function rowHandlers(camposFormulario, columnasFormulario, tableBodyId, nombreIndicePK, tableBD,tipo){
